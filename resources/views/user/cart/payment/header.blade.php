...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('bower_components/payment/css/animate.css') }}">
    <!-- Icomoon Icon Fonts-->
    <link rel="stylesheet" href="{{ asset('bower_components/payment/css/icomoon.css') }}">
    <link rel="stylesheet" href="{{ asset('bower_components/payment/css/flexslider.css') }}">
    <!-- Theme style  -->
    <link rel="stylesheet" href="{{ asset('bower_components/payment/css/style.css') }}">
    <link rel="stylesheet" href="{{ asset('bower_components/payment/css/custome.css') }}">
